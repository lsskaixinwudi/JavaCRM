...
insert  into `customer_contact`(`id`,`cus_id`,`contact_time`,`address`,`overview`) values (1,1,'2015-05-14','1','2'),(2,1,'2015-05-06','12','22'),(3,1,'2015-08-22','珠江路2','吃饭2');
...
insert  into `customer_linkman`(`id`,`cus_id`,`link_name`,`sex`,`position`,`office_phone`,`phone`) values (1,1,'1','男','321','321','21321'),(2,1,'2','女','21','321','321'),(4,1,'3','女','4','5','6'),(5,1,'33','男','44','55','66'),(6,1,'张三','男','经理','21321','32132121'),(7,1,'是','女','发送','2321','321321'),(10,1,'da','女','s','fd','fda');
...
insert  into `customer_loss`(`id`,`cus_no`,`cus_name`,`cus_manager`,`last_order_time`,`confirm_loss_time`,`state`,`loss_reason`) values (9,'KH20150526073022','风驰科技','小红','2014-03-02','2015-08-21',1,'客户公司倒闭！'),(10,'KH20150526073023','巨人科技','小丽','2014-02-03',NULL,0,NULL),(11,'KH20150729090910','12','小张',NULL,NULL,0,NULL);
...
insert  into `customer_order`(`id`,`cus_id`,`order_no`,`order_date`,`address`,`state`) values (1,1,'DD11213','2015-07-01','11',0),(2,16,'DD11212','2014-03-02','22',1),(3,16,'DD21321','2014-02-02','22',1),(4,17,'DD2121','2014-02-03','ss',1);

/*Table structure for table `customer_reprieve` */

DROP TABLE IF EXISTS `customer_reprieve`;

CREATE TABLE `customer_reprieve` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `customer_reprieve` */

insert  into `customer_reprieve`(`id`,`loss_id`,`measure`) values (1,9,'ss2'),(3,10,'111'),(4,9,'打电话咨询客户'),(5,9,'请吃饭');
...
insert  into `datadic`(`id`,`data_dic_name`,`data_dic_value`) values (1,'客户等级','普通客户'),(2,'客户等级','重点开发客户'),(3,'客户等级','大客户'),(4,'客户等级','合作伙伴'),(5,'客户等级','战略合作伙伴'),(6,'服务类型','咨询'),(7,'服务类型','建议'),(8,'服务类型','投诉');
...
insert  into `order_details`(`id`,`order_id`,`goods_name`,`goods_num`,`unit`,`price`,`sum`) values (1,1,'联想笔记本',2,'台',4900,9800),(2,1,'惠普音响',4,'台',200,800),(3,2,'罗技键盘',10,'个',90,900),(4,3,'艾利鼠标',20,'个',20,400),(5,3,'东芝U盘',5,'个',105,525),(6,4,'充电器',1,'个',30,30);
...
insert  into `product`(`id`,`product_name`,`model`,`unit`,`price`,`store`,`remark`) values (1,'联想笔记本','Y450','台',4500,120,'好');
...
CREATE TABLE `sale_chance` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `chance_source` varchar(300) DEFAULT NULL,
